---
title: "Real-world time series data - My journey - Episode 1"
published: true
---
...
However, I found myself with two problems: **data** and **complexity**. 

In epilepsy, few datasets contain peripheral data (data beyond EEG) and none existed when I started my PhD. Thus, I relied on self-collected data, **supervising** the acquisition of 60 patients for 3 years, and **expanding** from 1 epilepsy monitoring unit (EMU) to another, by **leading** the contact between the institute and the hospital.
